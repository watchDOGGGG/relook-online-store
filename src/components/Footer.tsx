        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://wa.me/2348135249526"
                target="_blank"
            ...
            <div className="mt-6 space-y-2 text-sm text-primary-foreground/70">
              ...
              <a href="tel:+2348135249526" className="block hover:text-accent transition-colors">
                +234 813 524 9526
              </a>
              <a href="tel:+2348147134884" className="block hover:text-accent transition-colors">
                +234 814 713 4884
              </a>
            </div>
          </div>
      ...
      <div className="border-t border-primary-foreground/20">
        <div className="container-wide py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <span className="text-xl font-black tracking-tighter uppercase">Relook Stores</span>
          </div>
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-primary-foreground/70">
            ...
            <span>© 2026 Relook Stores. All rights reserved.</span>
          </div>
        </div>
      </div>
    </footer>
